...
class KERGE_Start_Page_Widget extends WP_Widget
{
    ...
    public function widget( $args, $instance )
    {
        ...
        ?>
            ...
            <section data-id="<?php echo esc_attr($start_page_slug); ?>" data-title="<?php echo esc_attr($title); ?>" class="pt-page pt-page-<?php echo esc_attr($start_page_slug); ?> start-page <?php echo esc_attr($start_page_style); ?>">
                            ...
                            <div class="title-block">
                                ...
                                <div class="owl-carousel text-rotation">                                    
                                    <?php foreach (( function_exists('fw_get_db_settings_option') ) ? fw_get_db_settings_option('sp_style/first-style/hp_subtitles') : '' as $kerge_project_tags): ?>
                                        <div class="item">
                                            <div class="sp-subtitle"><?php echo esc_html($kerge_project_tags); ?></div>
                                        </div>
                                    <?php endforeach; ?>
                                </div>
                                <?php endif; ?>
