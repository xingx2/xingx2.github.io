...
wp_enqueue_style('kerge-main-styles', get_template_directory_uri().'/css/main.css',array(),'2.4.1');

$theme_style = ( function_exists('fw_get_db_settings_option') ) ? fw_get_db_settings_option('theme_style_picker') :  'light';
if( $theme_style == 'dark' ) {
    wp_enqueue_style('kerge-dark-styles', get_template_directory_uri().'/css/dark-styles.css',array(),'2.4.1');
}

wp_enqueue_style('kerge-customization', get_template_directory_uri().'/css/customization.css.php',array(),'2.4.1');
...
if ( is_page_template( 'page-templates/template-kerge-vcard.php' ) ) {
    wp_enqueue_script('page-animations', get_template_directory_uri().'/js/page-animations.js',array(),'2.4.1',true);
}
...
wp_enqueue_script('kerge-jquery-main', get_template_directory_uri().'/js/main.js',array(),'2.4.1',true);
