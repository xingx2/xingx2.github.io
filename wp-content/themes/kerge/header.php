    ...
    <header id="site_header" class="header mobile-menu-hide">
        <div class="header-content clearfix">
            ...
            <div class="site-nav dl-menuwrapper">
                ...
                {
                    if(has_nav_menu('classic-menu')){ wp_nav_menu( array( 'menu_class' => 'kerge-classic-menu site-main-menu dl-menu dl-menuopen', 'theme_location' => 'classic-menu', 'container' => '', 'depth' => 6) ); }
            ...
            <div class="social-links">
                ...
                if ( !empty($kerge_header_social)) :
                    ...
                    ?>
                            <a href="<?php echo esc_url($kerge_header_social['link']); ?>" target="_blank"><i class="<?php echo esc_attr($kerge_header_social['icon']); ?>"></i></a>
                    <?php endif;
                    endforeach;
                endif;
                ?>
